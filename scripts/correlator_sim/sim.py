...
if __name__ == "__main__":
    ...
    vt_array("config/vt_correlator_sim.yaml", 22, 0)
    ...
    #         unique_seeds.add(randint(0, 2**63 - 1))
    ...
    #         for _ in tqdm(
    #             p.imap(run, [args + [i, unique_seeds[i]] for i in range(100)]),
    #             total=100,
    #             desc=desc,
    #             ascii=".>#",
    ...
    # print(
    #     f"\u001b[31;1m[sturdiws]\u001b[0m Finished processing in {(time.time() - t0):.3f} seconds"
    # )
