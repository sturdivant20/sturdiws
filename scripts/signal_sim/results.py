...
if __name__ == "__main__":
    ...
    nav, err, channels = ParseSturdrLogs(
        "/media/daniel/Sturdivant/Thesis-Data/Signal-Sim/drone-sim/CNo_20_dB/Run26", True, True
    )
    # nav, channels = ParseSturdrLogs("./results/Signal-Sim/ground-sim/CNo_40_dB/Run1", False, False)
    # nav, channels = ParseSturdrLogs(
    #     "/media/daniel/Sturdivant/Thesis-Data/Signal-Sim/ground-sim/CNo_38_dB/Run0", True, False
    # )
