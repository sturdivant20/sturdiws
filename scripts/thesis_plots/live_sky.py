...
if __name__ == "__main__":
    ...
    sns.lineplot(x=nav["tR"], y=course, color="#a2e3b8", ax=mya.ax[2], label="SturDR")
    sns.lineplot(x=nav["tR"], y=rpy[:, 2], color="#a52a2a", ax=mya.ax[2], label="Ublox")
    sns.lineplot(x=nav["tR"], y=ubx_rpy[:, 2], color="#100c08", ax=mya.ax[2], label="GPS Course")
